...
def main():
    ...
    parser.add_argument('--preprocesseddir', type=str, default="/path/to/PICAI/output/")
    parser.add_argument('--outputdir', type=str, default="/path/to/PICAI/result/")
    parser.add_argument('--checkpointsdir', type=str, default="/path/to/PICAI/result/")
    ...
    ap_list = (preprocessed_dir / "segmentation/segdata/data_3d").glob("*.hdf5")
