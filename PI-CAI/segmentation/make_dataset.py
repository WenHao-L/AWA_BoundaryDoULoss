...
if __name__ == "__main__":
    ...
    make_segdata(
        base_dir="/path/to/PICAI/output/nnUNet_raw_data/Task2201_picai_baseline/imagesTr",
        label_dir="/path/to/PICAI/output/nnUNet_raw_data/Task2201_picai_baseline/labelsTr",
