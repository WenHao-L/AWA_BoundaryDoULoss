...
def main(taskname="Task2201_picai_baseline"):
    ...
    parser.add_argument('--workdir', type=str, default="/path/to/PICAI/workdir")
    parser.add_argument('--imagesdir', type=str, default=os.environ.get('SM_CHANNEL_IMAGES', "/path/to/PICAI/input/images"))
    parser.add_argument('--labelsdir', type=str, default=os.environ.get('SM_CHANNEL_LABELS', "/path/to/PICAI/input/picai_labels"))
    parser.add_argument('--outputdir', type=str, default=os.environ.get('SM_MODEL_DIR', "/path/to/PICAI/output"))
