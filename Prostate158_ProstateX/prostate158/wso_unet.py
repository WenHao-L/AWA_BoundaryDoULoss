...
from prostate158.WSO_PyTorch import WindowOptimizer
__all__ = ["WSO_UNet"]


class WSO_UNet(nn.Module):
    """
    ...
    def __init__(
        ...
        self.wso = WindowOptimizer(out_channels=1, act_window=act_window, upbound_window=upbound_window, window_init=window_init, mode="3D")
