...
class AWA_Module(nn.Module):
    def __init__(self, in_ch=3, gamma_range=[0., 1.], use_checkpoint=False):
        super().__init__()
    ...
    def apply_window(self, img, params_level, params_width):
        params_level = sigmoid_range(0, 1)(params_level)[..., None, None]
        params_width = sigmoid_range(0, 1)(params_width)[..., None, None]
...
if __name__ == "__main__":
    ...
    model = AWA_Module(in_ch=3).to(device='cpu')
